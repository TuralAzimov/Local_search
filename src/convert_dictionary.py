...
with open('imdb_3.csv', newline='', encoding="utf-8") as csvfile:                   #reading dataset
    reader = csv.reader(csvfile)
    with open('imdb_3_raw.txt', 'w', encoding="utf-8") as textfile:                   #writing it to the new text file
        for row in reader:
            textfile.write(row[0] + '\n')


with open('imdb_3_raw.txt', 'r', encoding="utf-8") as file:                           #reading the text file
    word_count = {}
    for line in file:
...
with open('dictionary_3.txt', 'w', encoding="utf-8") as file:                       #writing the collection to the dictionary file
